<template>
	<div class="product-list">
		...
		<div class="page-part">
			<!--<mu-list-item  v-for='sub in productList'
				:key='sub.productKey'
				:title='sub.productName'
				:describeText="sub.productDesc"
				slot='nested' >
				<mu-avatar icon="settings_system_daydream" slot="leftAvatar"/>
				<mu-icon-menu slot="right" icon="info" tooltip="操作">
        			<mu-menu-item title="修改" @click='openEditDialog(sub)'/>
        			<mu-menu-item title="删除" @click='openDelDialog(sub)'/>
        		</mu-icon-menu>
        	</mu-list-item>-->
        	<mu-list>
        	<mu-list-item v-for='item in productList'
        		:key='item.productKey'
        		:title='item.productName'
        		:describeText="item.productDesc"
        		...
        		<mu-list-item  v-for='sub in item.deviceList'
        			:key='sub.deviceId'
        			:title='sub.deviceAlias'
        			:describeText="sub.deviceName"
        			slot='nested'>
        			<mu-float-button v-if='!sub.groupName' slot='right' icon="add" mini class="add-group" @click='openAllocGroup(sub.deviceId)'/>
        		</mu-list-item>
        	</mu-list-item>
        	</mu-list>
		</div>
